    ...
    <section className="px-6 md:px-16 py-section">
      <div className="max-w-5xl mx-auto justify-between">
        ...
        <ul className="grid grid-cols-2 md:grid-cols-3 gap-8 ">
          <li className="flex flex-col gap-2 p-6 rounded-xl bg-bg-elevated/50 dark:bg-bg-elevated items-center text-center border border-gray-200 dark:border-gray-800">
          ...
          <li className="flex flex-col gap-2 p-6 rounded-xl bg-bg-elevated/50 dark:bg-bg-elevated items-center text-center border border-gray-200 dark:border-gray-800">
            ...
            <span className="text-gray-700 dark:text-gray-300  font-medium">2001.05.21</span>
          </li>
          <li className="flex flex-col gap-2 p-6 rounded-xl bg-bg-elevated/50  dark:bg-bg-elevated items-center text-center border border-gray-200 dark:border-gray-800">
          ...
          <li className="flex flex-col gap-2 p-6 rounded-xl bg-bg-elevated/50 dark:bg-bg-elevated items-center text-center border border-gray-200 dark:border-gray-800">
            ...
            <span className="text-gray-700 dark:text-gray-300 font-medium">SQLD, 정보처리기사(필기)</span>
          </li>
        </ul>
      </div>
    </section>
